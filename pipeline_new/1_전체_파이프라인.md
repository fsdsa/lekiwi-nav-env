...
Critic은 Actor obs에 더해서 물체 바운딩박스, 질량 등 더 많은 privileged 정보를 받는다.
...
Phase 5: 실배포
  ...
  [⬜] Sim→Real action transform 적용 (deploy_vla_action_bridge.py 검증)
  [⬜] 실험 C1~C7 실행
```
