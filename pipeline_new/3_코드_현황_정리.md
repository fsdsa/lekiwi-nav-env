...
| `lekiwi_skill3_env.py` | 425 | Skill-3 CarryAndPlace 환경 (intentional place + CRITICAL-2 fix + batched reset) |
...
class Skill3EnvCfg(Skill2EnvCfg):
    ...
    handoff_arm_noise_std: float = 0.02
    handoff_base_pos_noise_std: float = 0.01
    handoff_base_yaw_noise_std: float = 0.02
