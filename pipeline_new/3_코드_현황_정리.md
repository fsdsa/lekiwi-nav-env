...
>
> **서버(A100) 설치/전송/검증/학습 가이드**: `feedback/server_guide.md` 참조
...
| 파일 | 줄수 | 역할 |
|------|------|------|
| `lekiwi_skill1_env.py` | ~1240 | Skill-1 Navigate RL 환경 (장애물 회피 + pseudo-lidar + 감속, 20D actor / 25D critic) |
...
| `record_teleop.py` | 766 | `--skill` 분기, v6 action format, `arm_limit_write_to_sim=False`, wrist_roll 디버그 출력 |
