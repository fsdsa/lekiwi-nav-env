...
env_cfg.grasp_max_object_dist = 0.50    # training과 일치
env_cfg.grasp_success_height = 1.00     # 사실상 비활성화 — lift 중 auto-reset 방지
env_cfg.grasp_ee_max_dist = 0.05        # training env default와 일치
...
if demo_file is not None:
    ...
    # training과 동일한 spawn heading 설정
    env_cfg.spawn_heading_noise_std = 0.3
    env_cfg.spawn_heading_max_rad = 0.5

env_cfg.episode_length_s = 300.0  # training과 일치
...
per_dim_action_scale[5]   = 0.30   # gripper — training과 일치
