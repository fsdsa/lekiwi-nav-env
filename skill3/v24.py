...
def main_combined():
    ...
    while gs < args.total_timesteps:
        ...
        s3_scale_b[6:9] = 0.10    # base: 미세 위치 조정
        ...
        for step in range(S):
            ...
            with torch.no_grad():
                ...
                entered_b = _is_s3 & s3_phase_a_latch & (s3_arm_rise_ct >= 5) & (bdxy < 0.40)
                if entered_b.any():
                ...
                _lowered_done = _in_b & _holding_cur & (_src_h_cur < 0.05) & (_sdxy_cur < 0.25)
