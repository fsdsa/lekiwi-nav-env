    ...
    while gs < args.total_timesteps:
        ...
        for step in range(S):
            ...
            with torch.no_grad():
                ...
                _grip_opening = _in_b & (_grip_cur > 0.60)
                s3_grip_open_ct[_grip_opening] += 1
                s3_grip_open_ct[~_grip_opening & _in_b] = 0
                ...
                _retract_ready = _in_c & (_grip_cur >= 0.95) & (~_holding_cur)
            ...
            if is_s3.any() and s3_v15:
                ...
                grip_open_q = torch.clamp((grip_pos - 0.30) / 0.95, 0.0, 1.0)
                ...
                # placed 정의: 두 가지 버전
                #
                # placed_for_release: grip > 0.60 필요 (wrist contact 문제 해결)
                #   → _grip_open_enough에서 사용 (release sustain counter)
                #
                ...
                placed_for_release = active & (grip_pos > 0.60) & (placement_err < 0.15) & (src_h < 0.06) & (src_upright > 0.70) & v15_ms_lowered
                ...
                in_lowered = active_h & near_dest & (lower_dist < V15_LOWER_TOL) & (src_h < 0.06)
                ...
                # M3: Released — placed + grip > 1.0 sustained 10 steps (+150)
                _grip_open_enough = active & placed_for_release & (grip_pos > 1.0)
